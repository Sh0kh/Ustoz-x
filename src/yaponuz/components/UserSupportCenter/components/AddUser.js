...
export default function AddUser({ refetch }) {
  ...
  const showAlert = (response) => {
    ...
    if (response.success) {
      Swal.fire("Yangi yordam markazi qo‘shildi", response.message, "success").then(() => reload());
    } else {
