...
import UpdateAir from "../UpdateOther";
      ...
      newSwal
        ...
        .then(async (result) => {
          ...
          if (result.isConfirmed) {
            ...
            const response = await await Other.deleteOther(id, userId);
            loadingSwal.close();
    ...
    <SoftBox display="flex" alignItems="center">
      <SoftBox>
        <SoftTypography variant="body1" color="secondary" sx={{ cursor: "pointer", lineHeight: 0 }}>
          <PreviewOther id={myid} />
        </SoftTypography>
      </SoftBox>
      <SoftBox mx={2}>
        <SoftTypography variant="body1" color="secondary" sx={{ cursor: "pointer", lineHeight: 0 }}>
          <UpdateOther myid={myid} itemme={itemme} refetch={refetch} />
        </SoftTypography>
      </SoftBox>
      <SoftTypography
        variant="body1"
